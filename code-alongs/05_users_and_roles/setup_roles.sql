...
CREATE ROLE ice_cream_reader COMMENT = 'Able to read ice cream database';
CREATE ROLE ice_cream_writer COMMENT = 'Able to do CRUD operations on ice cream database';
...
GRANT ROLE ice_cream_writer TO USER JOHNSANDSJOSTUD;
